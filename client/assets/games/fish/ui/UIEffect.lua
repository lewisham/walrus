...
local M = class("UIEffect", wls.UIGameObject)
...
function M:playFishDeadEff(fish, viewID)
    -- 鱼死亡音效
    ...
    self:find("UICoinMgr"):play(fish.position, tonumber(fish.config.coin_num), viewID, math.random(10, 100))
    -- 特效音效
